...
public class AddressesController {
	...
	public Result updateSameAddress(@RequestBody UpdateAddressRequest updateAddressRequest) {
		return this.addressService.updateSameAddress(updateAddressRequest)	;	
	}
	@PostMapping("/updatedifferentaddress")
	public Result updateDifferentAddress(@RequestBody UpdateAddressRequest updateAddressRequest) {
