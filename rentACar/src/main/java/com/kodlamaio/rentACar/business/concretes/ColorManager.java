...
public class ColorManager implements ColorService {
	...
	public Result update(UpdateColorRequest updateColorRequest) {
		checkIfColorExitsById(updateColorRequest.getId());
	...
	public Result delete(DeleteColorRequest deleteColorRequest) {
		...
		checkIfColorExitsById(deleteColorRequest.getId());
	...
	public DataResult<ReadColorResponse> getById(int id) {
		Color color = checkIfColorExitsById(id);
	...
	private Color checkIfColorExitsById(int id) {
		Color currentColor;
		try {
	...
	public Color getColorById(int id) {
		...
		return checkIfColorExitsById(id);
	}
	}
